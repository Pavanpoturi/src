...
export default function TemplateExhumationOnComplaintOfRelativesOrLocals({
  fileName,
  data,
}) {
  const {
          ...
          <tr>
            ...
            >
              <p>
                ...
                was cremated without police formalities and post-mortem
                examination. They expressed suspicion over the death of the
                deceased and requested for legal action.
              </p>
              <p>
                &emsp;&emsp;&emsp;&nbsp;In this connection, a case under
                reference is registered and investigation taken up.
              </p>
              <p>
