...
export default function TemplateForwardingOfFPS({ fileName, data }) {
  const {
    policeStation = "",
    firNumber = "",
    sectionOfLaw = "",
              ...
              <table style={{ width: "100%" }}>
                ...
                >
                  <tr>
                    ...
                    <td>
                      Forwarding of Finger Prints of unknown dead body - reg
                    </td>
                  </tr>
                  <tr>
                    <td width="6%" style={{ verticalAlign: "top" }}>
          ...
          <tr>
            ...
            >
              <p>
                ...
                >
                  {" "}
                  {complainantaddress || "________________"}{" "}
                </span>{" "}
              ...
              <p>
                &emsp;&emsp;&emsp;&nbsp;&nbsp;In this connection finger prints
                of the unknown dead body has been collected by FP Experts in the
                above referred crime.
              </p>
              <p>
                &emsp;&emsp;&emsp;&nbsp;&nbsp; Hence, it is requested to compare
                the finger prints of deceased with that of the Data base
                available and furnish your opinion.
              </p>
