...
export default function TemplateSectionAlterMemo({ fileName, data }) {
  const {
    policeStation = "",
    firNumber = "",
    sectionOfLaw = "",
        ...
        <tbody style={{ fontSize: 17, fontFamily: "Arial" }}>
          ...
          <tr>
            <td>
              ...
              <br />
              <p>
                &emsp;&emsp;&emsp;&nbsp;In the light of the above, I am altering
                section of law from{" "}
                <span
                  style={{
                    padding: "0 10px",
                ...
                and it is prayed that the Honourable Court may kindly read the
                section of law as{" "}
                <span
                  style={{
                    padding: "0 10px",
