...
export default function Template164CrPcWitness({ fileName, data }) {
  const {
    policeStation = "",
    firNumber = "",
    sectionOfLaw = "",
                ...
                >
                  <tr>
                    ...
                    <td>
                      ...
                      - Request for recording statement of witness u/s 164
          ...
          <tr>
            ...
            >
              <p>
                ...
                >
                  {complainantstatememt || "____________"}
                </div>
              </p>
              <p>
              ...
              <p>
                ...
                following witnesses are very vital to the prosecution and there
                is every likelihood of they being gained over by the accused.{" "}
              </p>
            </td>
          </tr>
          <tr>
                  ...
                  {!isEmpty(accusedDetails) &&
                    accusedDetails.map((item, i) => {
                      return (
                        <tr key={i}>
                          {item?.witnessCode ? (
                            <td width="15%">{item?.witnessCode}</td>
                          ) : null}
                          <td
                            style={{
                              padding: "0 10px",
