...
export default function TemplateLetterToRtaOnDrivingLicence({
  fileName,
  data,
}) {
  const {
        ...
        <tbody style={{ fontSize: 17, fontFamily: "Arial" }}>
                ...
                >
                  <tr>
                    ...
                    <td>
                      ...
                      - Request for verification of genuineness of Driving
                      Licence – reg
                    </td>
                  </tr>
                  <tr>
          ...
          <tr>
            ...
            >
              ...
              up wherein fake driving licences are found. <br />
              <br />
              &emsp;&emsp;&emsp;&nbsp;In this connection, copies of following
              Driving Licences are forwarded and it is requested to clarify the
              genuineness
              <br />
              <br />
            </td>
              ...
              >
                <tbody style={{ fontSize: 17, fontFamily: "Arial" }}>
                  <tr>
                    ...
                    <td>
                      <b>Driving Licence No and date of issue</b>
                    </td>
                    <td>
                      <b>Name of the holder</b>
                    </td>
                    <td>
                      <b>Authorised to drive And Validity</b>
                    </td>
                    <td>
                      <b>Issued by </b>
                    </td>
