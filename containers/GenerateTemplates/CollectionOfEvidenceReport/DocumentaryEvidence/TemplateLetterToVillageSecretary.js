...
export default function TemplateLetterToVillageSecretary({ fileName, data }) {
  const {
    policeStation = "",
    firNumber = "",
    sectionOfLaw = "",
        ...
        <tbody>
          ...
          <tr>
            <td style={{ fontSize: 17, fontFamily: "Arial" }}>
              ...
              <br />
              __________________GRAM PANCHAYAT
              <br />
            </td>
          </tr>
          <tr>
                ...
                >
                  <tr>
                    ...
                    <td>
                      ...
                      - Request for clarification on GENUINESS OF LAY OUT - reg
                    </td>
                  </tr>
                  <tr>
                    <td width="6%" style={{ verticalAlign: "top" }}>
          ...
          <tr>
            ...
            >
              ...
              clarify as to whether the layout (copy enclosed) is approved by
              Gram Panchayat. If so, furnish attested copy of layout for the
