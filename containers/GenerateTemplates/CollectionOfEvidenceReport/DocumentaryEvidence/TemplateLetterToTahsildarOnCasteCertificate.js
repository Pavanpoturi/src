...
export default function TemplateLetterToTahsildarOnCasteCertificate({
  fileName,
  data,
}) {
  const {
        ...
        <tbody style={{ fontSize: 17, fontFamily: "Arial" }}>
                ...
                >
                  <tr>
                    ...
                    <td>
                      ...
                      Request for verification of genuineness of the caste
                      certificates . - reg
                    </td>
                  </tr>
                  <tr>
          ...
          <tr>
            ...
            >
              ...
              up with regard to the fake caste certificates. <br />
              <br />
              &emsp;&emsp;&emsp;&nbsp;In this connection, the following copies
              of caste certificates suspected to be fake are herewith forwarded
              and it is requested to clarify the genuineness of the same for the
