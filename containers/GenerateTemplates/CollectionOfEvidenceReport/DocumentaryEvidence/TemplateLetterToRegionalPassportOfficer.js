...
export default function TemplateLetterToRegionalPassportOfficer({
  fileName,
  data,
}) {
  const {
        ...
        <tbody style={{ fontSize: 17, fontFamily: "Arial" }}>
          ...
          <tr>
            <td style={{ fontSize: 17, fontFamily: "Arial" }}>
              <br /> To,
              <br />
              The Regional Passport Officer /<br />
              __________
              <br />
            </td>
          </tr>
                ...
                >
                  <tr>
                    ...
                    <td>
                      ...
                      Request for verification of Passport . - reg
                    </td>
                  </tr>
                  <tr>
                    <td width="6%" style={{ verticalAlign: "top" }}>
          ...
          <tr>
            ...
            >
              ...
              up with regard to the fake passport. <br />
              <br />
              &emsp;&emsp;&emsp;&nbsp;In this connection, the following copies
              of passport suspected to be fake are herewith forwarded and it is
              requested to clarify the genuineness of the same for the purpose
              of investigation.
              <br />
              <br />
            </td>
              ...
              >
                <tbody style={{ fontSize: 17, fontFamily: "Arial" }}>
                  <tr>
                    ...
                    <td>
                      <b>Name and address of Passport holder</b>
                    </td>
                    <td>
                      <b>Issued on</b>
                    </td>
