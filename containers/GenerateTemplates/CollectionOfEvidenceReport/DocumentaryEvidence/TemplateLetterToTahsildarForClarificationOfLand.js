...
export default function TemplateLetterToTahsildarForClarificationOfLand({
  fileName,
  data,
}) {
  const {
        ...
        <tbody style={{ fontSize: 17, fontFamily: "Arial" }}>
                ...
                >
                  <tr>
                    ...
                    <td>
                      ...
                      - Request for clarification on land - reg
                    </td>
                  </tr>
                  <tr>
                    <td width="6%" style={{ verticalAlign: "top" }}>
          ...
          <tr>
            ...
            >
              ...
              clarify as to the nature of land and history in respect of the
              following land and also what is recorded in revenue records and
              also furnish relevant pahani copies.
              <br />
              <br />
            </td>
          </tr>
