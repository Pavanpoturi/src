...
export default function TemplateLetterToCoopHousingSociety({ fileName, data }) {
  const {
    policeStation = "",
    firNumber = "",
    sectionOfLaw = "",
            ...
            <td style={{ fontSize: 17, fontFamily: "Arial" }}>
              ...
              >
                ...
                >
                  ...
                  <tr>
                    <td width="10%">1</td>
                    <td>Society Registration form</td>
                  </tr>
                  <tr>
                    <td>2</td>
                    <td>Names and addresses of Board Members</td>
                  </tr>
                  <tr>
                    <td>3</td>
                    <td>Register of Member Ship</td>
                  </tr>
                  <tr>
                    <td>4</td>
                    <td>Date of last Annual General Body meeting</td>
                  </tr>
                  <tr>
                    <td>5</td>
                    <td>Register of Allotment of plots</td>
                  </tr>
                  <tr>
                    <td>6</td>
                    <td>Audit report of Coop registrar</td>
                  </tr>
                  <tr>
                    <td>7</td>
                    <td>Specific enquiries reports, any</td>
                  </tr>
                  <tr>
                    <td>8</td>
                    <td>
                      Original layout and subsequent layouts if any
                      modifications
                    </td>
                  </tr>
