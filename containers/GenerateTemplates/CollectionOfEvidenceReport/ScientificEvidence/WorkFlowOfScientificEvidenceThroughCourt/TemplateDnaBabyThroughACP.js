...
export default function TemplateDnaBabyThroughACP({ fileName, data }) {
  const {
    policeStation = "",
    firNumber = "",
    sectionOfLaw = "",
      ...
      <table style={{ width: "100%" }}>
        <tbody style={{ fontSize: 17, fontFamily: "Arial" }}>
          ...
          <tr>
            ...
            >
              No.
              <span style={{ paddingLeft: "5px", textAlign: "center" }}></span>/
              <span
                style={{
                  padding: "0 10px",
                  width: 200,
                ...
                <tbody style={{ fontSize: 17, fontFamily: "Arial" }}>
                  <tr>
                    ...
                    <td>
                      ...
                      – Request for collection of blood samples of NEWLY BORN
                      BABY for DNA Examination – reg.
                    </td>
                  </tr>
                  <tr>
                    <td width="6%" style={{ verticalAlign: "top" }}>
          ...
          <tr>
            <td style={{ fontSize: 17, fontFamily: "Arial" }}>
              <div style={{ paddingLeft: "50px", border: "1px dashed #ccc" }}>
                <b>
                  <u>NAME AND ADDRESS OF NEWLY BORN BABY</u>
                </b>
                <br />
                {babydarrList.map((item, index) => {
                  return (
                    <label key={index}>
                      {`${item.accusedName} ${
          ...
          <tr>
            ...
            >
              ...
              blood samples of the above said baby for DNA examination.
            </td>
          </tr>
          <br />
          <br />
