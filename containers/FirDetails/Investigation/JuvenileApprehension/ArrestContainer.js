...
export default function ArrestContainer(props) {
  ...
  console.log("selectedArrestValue", selectedArrestValue);
      ...
      <>
        <div className="widgetPageStyle">
          ...
          >
            <Row gutter={24}>
              <Col span={8}>
                <Form.Item name="arrestType" label="Type of Apprehension">
                  {renderFieldsWithDropDown(
                    arrestOptions,
                    setSelectedArrestType,
                    220,
              ...
              {arrestTypeData.map((s, i) => {
                const isLabel =
                  s.label === "Place of Apprehension" ||
                  s.label === "Apprehensioned On" ||
                  s.label === "Place of Taken into Custody" ||
                  s.label === "Taken into Custody On" ||
                  s.label === "Apprehended By" ||
                  s.label === "Apprehensioned By other Police On";
                return (
