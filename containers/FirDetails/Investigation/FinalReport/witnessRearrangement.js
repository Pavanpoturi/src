...
import { isEmpty, filter, size, isArray, isUndefined } from "lodash";
      ...
      },
      {
        ...
        render: (typeOfwitness, val) => {
          ...
          if (typeOfwitness === "Official witnesses / Experts") {
            ...
            let subType =
              !isUndefined(val?.panchSubTypeOfWitness) &&
              isArray(val?.panchSubTypeOfWitness)
                ? val?.panchSubTypeOfWitness.join()
                : !isUndefined(val?.subTypeOfWitness)
                ? val?.subTypeOfWitness
                : "";
            label = `${val?.typeOfWitness} ${subType}`;
